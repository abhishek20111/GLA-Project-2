        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data.error) {
              ...
              notify1("Please Verify From Email...");
            }
            navigate("/signin");
          })
          .catch((error) => {
            notify4("Problem Occurred, Try Again..");
          ...
          <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="w-full flex border-black mt-2 px-3  text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg">
