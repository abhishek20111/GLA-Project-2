...
export default () => {
  ...
  return (
    <footer className="w-full border-t-4 border-white text-white bg-gray-800 px-4 py-5 md:pt-16 mx-auto md:px-8">
      <Zoom>
        <div className="max-w-lg sm:mx-auto sm:text-center mb-16 flex flex-col items-center">
          <img src={GIF} className="w-32 sm:mx-auto py-16" />
          <div className="mb-16">
          ...
          <div className="mt-6 sm:mt-0 pb-16">
          ...
          <div className="mt-8 items-center justify-between sm:flex">
            <div className="mt-4 sm:mt-0">
              &copy; 2023 LearnUp All rights reserved.
            </div>
          </div>
        </div>
